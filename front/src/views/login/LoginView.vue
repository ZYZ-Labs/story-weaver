    ...
    <v-row class="fill-height ma-0">
      <v-col cols="12" lg="7" class="d-none d-lg-flex align-center justify-center">
        <div style="max-width: 620px" class="pa-10">
          <div class="text-overline text-secondary">AI Native Story System</div>
          <div class="text-h2 font-weight-bold mt-3 text-primary">
            从世界设定到 AI 续写，把小说创作真正串起来。
          </div>
          <div class="text-h6 text-medium-emphasis mt-5">
            一个面向长篇创作的工作台，覆盖项目、章节、角色、因果、RAG 与模型管理。
          </div>
          <v-row class="mt-8" dense>
            <v-col cols="6">
              <v-card class="soft-panel">
                <v-card-text>
                  <div class="text-h5 font-weight-bold">多模块协同</div>
                  <div class="text-body-2 text-medium-emphasis mt-2">
                    项目、章节、人物、因果和 AI 输出共用同一上下文。
                  </div>
                </v-card-text>
              </v-card>
            </v-col>
            <v-col cols="6">
              <v-card class="soft-panel">
                <v-card-text>
                  <div class="text-h5 font-weight-bold">确认后入库</div>
                  <div class="text-body-2 text-medium-emphasis mt-2">
                    AI 先生成草稿，再确认写回章节与 RAG 记忆流。
                  </div>
                </v-card-text>
              </v-card>
            </v-col>
